...
public class HelloWorld extends PApplet {
    ...
    public void setup() {
        ...
        map1 = new UnfoldingMap(this, 25, 25, 350, 500, provider);
        ...
        //cords: x, y, h, w
        map2 = new UnfoldingMap(this, 425, 25, 350, 500, provider);
        map2.zoomAndPanTo(zoomLevel, new Location(53.35f, -6.27f));
